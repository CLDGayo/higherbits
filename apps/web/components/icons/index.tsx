...
export const Icons = {
  ...
  antigravityLogo: (props: LucideProps) => (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <defs>
        <linearGradient id="antigrav-grad" x1="0%" y1="100%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#4CA1F0" />
          <stop offset="30%" stopColor="#5BCA8A" />
          <stop offset="50%" stopColor="#F59E0B" />
          <stop offset="70%" stopColor="#EF4444" />
          <stop offset="100%" stopColor="#6366F1" />
        </linearGradient>
      </defs>
      <path d="M 20 170 Q 100 -150 180 170 A 20 20 0 0 1 140 170 Q 100 -80 60 170 A 20 20 0 0 1 20 170 Z" fill="url(#antigrav-grad)" />
    </svg>
  ),
  goHighLevelLogo: (props: LucideProps) => (
    <svg viewBox="0 0 440 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      {/* Yellow Arrow */}
