...
**MANDATORY GRAPHIFY RULE (ALWAYS FIRST):**
Before inspecting files or making edits, run `graphify query "<target component/file/concept>"` to check the knowledge graph. After editing code, run `graphify update .`.
