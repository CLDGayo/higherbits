---
name: plan:higherbits-creator-studio-umbrella
description: "HigherBits Creator Studio — umbrella/orchestration plan for the 5-phase program"
date: 09-07-26
metadata:
  node_type: memory
  type: plan
...
# HigherBits Creator Studio — Umbrella Plan
...
- Date: 09-07-26
- Feature folder: `process/features/higherbits-creator-studio/`
...
```
HigherBits Creator Studio — Program Goal Charter

North star:
- Port and adapt the 21st.dev-style Creator Studio to support NextJS, React Native, and Vanilla Web code editors.

Definition of done (an unattended agent must be able to do all of these):
1. User can open a + New component dropdown and select NextJS, React Native, or Vanilla Web.
2. Each selection routes to a fully functional in-browser editor (Sandpack/Live Preview).
3. Code from these editors can be persisted, submitted, and enter the on_review → posted → featured pipeline.

What "verified" means (program level):
- All three editor variants (Next.js, Expo, Vanilla Web) render, allow code editing, show a live preview, and submit properly to the database.
...
- Tier 1 Editor Selection UI → Phase 1
- Tier 2 Next.js Editor → Phase 2
- Tier 3 React Native Editor → Phase 3
- Tier 4 Vanilla Web Editor → Phase 4
- Tier 5 Persistence Pipeline → Phase 5
- This program retires Tiers 1-5.

Explicitly out of scope (deferred tier):
- Implementing advanced IDE features (LSP, intellisense, git integration).
- Integrating user authentication (already exists, but out of scope to build anew).

Hard safety constraints (non-negotiable, per phase):
- Never delete existing component data during editor tests.
...
```
SESSION GOAL: higherbits-creator-studio — HigherBits Creator Studio
Ref: process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/higherbits-creator-studio-umbrella_PLAN_09-07-26.md

TARGET: Complete ALL phases until:
- All 5 phases exit gates are green.
...
- Never mutate existing prod-like DB data without explicit test scaffolding.
...
| 1 — Editor Selection UI | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-01-selection-ui_PLAN_09-07-26.md` | Dropdown UI for picking editor type | Phase 0 |
| 2 — Next.js Editor | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-02-nextjs-editor_PLAN_09-07-26.md` | Sandpack environment for React | Phase 1 |
| 3 — React Native Editor | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-03-react-native-editor_PLAN_09-07-26.md` | Expo environment for React Native | Phase 2 |
| 4 — Vanilla Web Editor | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-04-vanilla-editor_PLAN_09-07-26.md` | Vanilla JS/Three.js environment | Phase 3 |
| 5 — Submission Pipeline | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-05-submission-pipeline_PLAN_09-07-26.md` | Wiring components to save to DB | Phase 4 |
...
| 1 | Phase 0 complete | UI selection correctly routes to respective paths |
| 2 | Phase 1 exit met | Next.js editor renders live preview and allows code edit |
| 3 | Phase 2 exit met | React Native editor renders Expo environment properly |
| 4 | Phase 3 exit met | Vanilla Web editor correctly renders HTML/CSS/JS |
| 5 | Phase 4 exit met | Submitted components persist correctly to the database |
...
- Never widen an allowlist without user approval.
...
|---|---|
| 0 (pre-program) | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-00-umbrella_REPORT_09-07-26.md` |
| 1 — Editor Selection UI | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-01-selection-ui_REPORT_09-07-26.md` |
| 2 — Next.js Editor | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-02-nextjs-editor_REPORT_09-07-26.md` |
| 3 — React Native Editor | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-03-react-native-editor_REPORT_09-07-26.md` |
| 4 — Vanilla Web Editor | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-04-vanilla-editor_REPORT_09-07-26.md` |
| 5 — Submission Pipeline | `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/phase-05-submission-pipeline_REPORT_09-07-26.md` |
...
| 01 — Editor Selection UI | ⏳ PLANNED |
| 02 — Next.js Editor | ⏳ PLANNED |
| 03 — React Native Editor | ⏳ PLANNED |
| 04 — Vanilla Web Editor | ⏳ PLANNED |
| 05 — Submission Pipeline | ⏳ PLANNED |
...
- Creator Studio components in `apps/web/`
- Editor views / pages for NextJS, React Native, Vanilla Web
- Schema/DB calls for component persistence

---

## Public Contracts

- `/studio` interface routes.
- Component Registry format for new types of components.
...
- New editor layout components in `apps/web/`
- Route files for `/studio/new` or similar structure
...
- Selected plan file path: `process/features/higherbits-creator-studio/active/higherbits-creator-studio_09-07-26/higherbits-creator-studio-umbrella_PLAN_09-07-26.md`
