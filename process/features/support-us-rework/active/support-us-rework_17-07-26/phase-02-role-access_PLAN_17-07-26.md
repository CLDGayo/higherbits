...
- [ ] A1. Extract the admin role from the `userState` context.
- [ ] A2. Conditionally wrap the "Contest" sections.
- [ ] A3. Conditionally wrap the "Purchased Bundles", "Bundles", and "Templates" sections.
- [ ] A4. Conditionally wrap the "Premium Stores" section.
- [ ] A5. Conditionally wrap the entirely of the "AI UI Builder" section.
